 ...
 */
final class Version20230604114141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE doctor (id INT NOT NULL, specializations_id INT DEFAULT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(100) NOT NULL, phone VARCHAR(12) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1FC0F36A6458BC80 ON doctor (specializations_id)');
        $this->addSql('CREATE TABLE manager (id INT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(100) NOT NULL, phone VARCHAR(12) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(100) NOT NULL, date_of_birth DATE NOT NULL, phone VARCHAR(12) NOT NULL, insurance VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
